...
char Inimeac::setTrame (const char* VitesseVent,const char* DirectionVent,const char* Temperature,const char* Hygrometrie, const char* Pression, const char* Validite){
  ...
  strcpy (this->m_TrameAppli,VitesseVent);
  strcat (this->m_TrameAppli,"!");
  strcat (this->m_TrameAppli,DirectionVent);
  strcat (this->m_TrameAppli,"!");
  strcat (this->m_TrameAppli,Temperature);
  strcat (this->m_TrameAppli,"!");
  strcat (this->m_TrameAppli,Hygrometrie);
  strcat (this->m_TrameAppli,"!");
  strcat (this->m_TrameAppli,Pression);
...
char* Inimeac::getTrameApplication(){
  return (this->m_TrameAppli);
}
