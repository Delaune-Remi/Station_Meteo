...
class CapteurCV3F {
	private:
		...
		int setDirectionVent();											// Fonction permettant de stocker dans la variable m_DirectionVentVent la valeur de la direction du vent issue de la trame NMEA_MWV
		int setVitesseVent();											// Fonction permettant de stocker dans la variable m_VitesseVent la valeur de la vitesse du vent issue de la trame NMEA_MWV
		int setTemperature();											// Fonction permettant de stocker dans la variable m_Temperature la valeur de la temperature issue de la trame NMEA_XDR
		bool validationTrameNMEA_MWV(const char* const TrameNMEA_MWV);	// Fonction permettant de savoir si la trame NMEA_MWV est correct (true or false)
	public:
