...
char Inimeac::decodeTrameINIMEAC(String m_TrameDecode,bool trameComplete,char* const VitesseVent, char* const DirectionVent, char* const Temperature, char* const Hygrometrie,char* const Pression){
  ...
  if (trameComplete==true) { 
      ...
      Hygrometrie[1]= m_TrameDecode[67];
      Hygrometrie[2]= m_TrameDecode[68];
      Hygrometrie[3]= m_TrameDecode[69];
      Hygrometrie[4]= m_TrameDecode[70];
      Hygrometrie[5]= m_TrameDecode[71];

      if (m_TrameDecode[82] != '1'){m_TrameDecode[88]=' ';}
      
      Pression[0]= m_TrameDecode[82];
      Pression[1]= m_TrameDecode[83];
      Pression[2]= m_TrameDecode[84];
      Pression[3]= m_TrameDecode[85];
      Pression[4]= m_TrameDecode[86];
      Pression[5]= m_TrameDecode[87];
      Pression[6]= m_TrameDecode[88];
  } 
}
